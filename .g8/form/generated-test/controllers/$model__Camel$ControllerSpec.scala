...
class $model;format="Camel"$ControllerSpec extends PlaySpec with GuiceOneAppPerTest with Injecting {
  ...
  "$model;format="Camel"$Controller GET" should {
    ...
    "render the appleInput page from a new instance of controller" in {
    ...
    "render the appleInput page from the application" in {
    ...
    "render the appleInput page from the router" in {
